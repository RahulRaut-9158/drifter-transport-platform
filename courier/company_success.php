...
<div style="max-width:560px;margin:80px auto;text-align:center;background:white;padding:48px 40px;border-radius:16px;box-shadow:var(--shadow);">
  ...
  <p style="color:var(--muted);margin-bottom:32px;line-height:1.7;">Your courier company has been added to Drifter. Customers in your service area will now be able to find and contact you.</p>
  <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;">
    <a href="company_info.php" style="display:inline-flex;align-items:center;gap:8px;padding:12px 24px;background:linear-gradient(135deg,#0891b2,#0c4a6e);color:white;border-radius:10px;text-decoration:none;font-weight:600;"><i class="fas fa-building"></i> View My Companies</a>
