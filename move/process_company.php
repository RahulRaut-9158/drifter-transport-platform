...
if (!$name || !$email || !$phone || !$address || !$locations || !$svc_type || !$prop_type || !$min_price || !$max_price) {
...
try {
    ...
    $stmt2 = $pdo->prepare('INSERT INTO services (company_id,service_type,min_price,max_price,property_type) VALUES (?,?,?,?,?)');
